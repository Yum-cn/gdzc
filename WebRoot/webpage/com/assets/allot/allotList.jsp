    ...
    <div id="bd">
    	...
    	<form name="searchForm" id="searchForm" method="post" action="allotController.do?list" class="layui-form layui-form-pane">
    	  <div class="layui-form-item">
		    ...
		    <div class="layui-input-inline">
				<input id="allotTime" name="allotTime" type="text"  onClick="WdatePicker()" value="<fmt:formatDate value="${allotTime}" pattern="yyyy-MM-dd"/>" placeholder="请选择日期" autocomplete="off" class="layui-input"/>
		    </div>
		    <div class="layui-input-inline">
					  ...
					  <table class="layui-table">
					    ...
					    <c:forEach items="${resultList}" var="resultList">
					      <tr>
					        ...
					        <td><a href="allotController.do?goUpdate&id=${resultList.id}" class="tablelink">查看转移单</a>  
